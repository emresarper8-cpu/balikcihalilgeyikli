...
export const metadata: Metadata = {
  ...
  description:
    "Balıkçı Halil Geyikli is a fish and seafood restaurant in Geyikli, Çanakkale. Enjoy fresh fish, seafood and traditional Aegean meze.",
  alternates: {
    canonical: "/en",
  },
  robots: {
      ...
      <section className="py-20 px-6 bg-[#071c2d]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-300 mt-6 text-lg">
            Cumhuriyet, Vatan Sk. 5
            <br />
            17610 Geyikli, Ezine, Çanakkale, Türkiye
          </p>
